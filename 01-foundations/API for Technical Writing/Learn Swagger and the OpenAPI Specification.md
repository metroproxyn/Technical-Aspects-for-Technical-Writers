...
Swagger is a set of open source tools, many of which you can host yourself. 
SwaggerHub is a commercial platform that lets you host API definitions.

## Why JSON over YAML sometimes?
...
## Alternatives to Swagger and OAS (Open API Specification)
...
- OAS is just one way to define Open API
- There are other specification that have been created
...
- I expect to see more and better alternatives in the near future
- Links to the alternatives and other resources are in the next section
