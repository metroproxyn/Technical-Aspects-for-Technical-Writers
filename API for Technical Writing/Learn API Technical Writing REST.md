...
- Easier to keep in sync with API

> ! This is a rapidly-changing field. I am not going to describe specific tools.

### Single Source tools

- Use the tool to write the documentation
- Generated several formats
  - HTML, PDF, Microsoft WOrd etc.
- Commonly used for end-user documentation
- Can look really nice
- Often overkill for API documentation

### Content management systems

- Web-based
- Web-documentation only
- Looks range from basic (Wikis) to sophisticated
- Often works very well for collaboration
- Not always good at handling tables

### Autogenerated documentation tools

- Generates documentation from data files
  - Often files are in JSON or XML
  - Typically, you cannot generate REST docs from code comments
- Allows you to try out the API from within the documentation
  - So perhaps you don't need sample responses (I do not agree)
- Really good if API is straightforward

### Markdown

- A simple mark-up language
- Like HTML, but without styling
  - Much simplier
  - Much easier to read than HTML
  - Can learn in under 30 minutes
- Showing up in autogenerated documentation tools and content management systems

### Making REST Requests

- As an API writer, you should be able to make REST requests
  - Often you can get answers without asking for help
- You don't need code
- REST clients: apps that allow you to make REST requests and see the responses
  - Just search for "REST client"
  - Example: Postman Chrome app

### Conclusion

- Tools help with web-based documentation, collaboration, and keeping in sync with API changes
- Single-source tools designed for end-user docs
- CMS are web-based, but can have trouble with tables
- Autogenerated doc tools keep docs in sync with API
- Markdown is a popular, simple markup language
- REST clients are used to make REST requests

## Next steps

- You know how to write reference documentation for RESTful APIs
- You still need to know how to write overview material
- The [Art of API Documentation](/API%20for%20Technical%20Writing/The%20Art%20of%20API%20Documentation.md) material covering:
  - Overview material
  - Tutorials
